"""System under test — supplied with the assessment, committed unmodified.

We track the code's behavior exactly as delivered by pinning any current bugs as explicit
failures in our testing framework. We do not patch the source files prematurely.
"""
...
class Model:
    ...
    def simulate(self, i1, i2):
        # Core mathematical simulation equations
...
# Default system model instance variable
